...
import org.dync.teameeting.TestActivity;
...
public class MainActivity extends Activity
{
	...
	private Handler mUIHandler = new Handler()
	{
		public void handleMessage(Message msg)
		{
			...
			case UPDATE_LISTVIEW_SCROLL:
				mAdapter.notifyDataSetChanged();
				mListView.animate().translationY(-mDy).setDuration(SHOW_EDIT_TEXT_TIME);
				break;
	...
	private void inint()
	{
		...
		mRlMain.getViewTreeObserver().addOnGlobalLayoutListener(new OnGlobalLayoutListener()
		{
			@Override
	...
	private boolean hideKeyboard()
	{
		if (mIMM.isActive(mCreateRoom))
		{
			...
			mIMM.hideSoftInputFromWindow(this.getCurrentFocus().getWindowToken(),
