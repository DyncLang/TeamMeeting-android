...
import org.dync.teameeting.PushSetActivity;
import org.dync.teameeting.R;
import org.dync.teameeting.R.anim;
import org.dync.teameeting.R.id;
import org.dync.teameeting.R.layout;
...
public class RoomSettingActivity extends Activity implements android.view.View.OnClickListener
{
	...
	public void onClick(View view)
	{
		...
		case R.id.tv_invite_weixin:
			// weixin
			intent = new Intent(RoomSettingActivity.this, PushSetActivity.class);
			startActivity(intent);
			finishActivity();
			break;
